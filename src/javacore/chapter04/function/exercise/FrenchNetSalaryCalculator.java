...
public class FrenchNetSalaryCalculator {
    ...
    public static double applyRevenueTax(double annualNetSalary){
        ...
        final double TAX_BRACKET_FULL_SECOND = (TAX_BRACKET_SECOND - TAX_BRACKET_FIRST) * TAX_BRACKET_PERCENTAGE_SECOND / 100;
        final double TAX_BRACKET_FULL_THIRD = ((TAX_BRACKET_THIRD - TAX_BRACKET_SECOND) * TAX_BRACKET_PERCENTAGE_THIRD / 100) + TAX_BRACKET_FULL_SECOND;
        final double TAX_BRACKET_FULL_FOURTH = ((TAX_BRACKET_FOURTH - TAX_BRACKET_THIRD) * TAX_BRACKET_PERCENTAGE_FOURTH / 100) + TAX_BRACKET_FULL_THIRD;
